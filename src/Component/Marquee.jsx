...
const Marquee = () => {
  ...
  return (
    <div data-scroll data-scroll-speed=".1"  className='w-full -mb-[3vw] py-[3vw] bg-[#004D43]'>
      <div className='text flex whitespace-nowrap border-t-2 p-2 border-b-2 overflow-hidden border-zinc-300 '>
        <motion.h1 
           initial={{ x:"0" }} 
           animate={{ x:"-100%" }} 
