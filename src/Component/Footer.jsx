...
const Footer = () => {
  return (
    <div className='flex h-screen bg-gradient-to-b from-black to-gray-900'>
      ...
      {/* Left Section */}
      <div className='flex flex-col justify-between items-center w-1/2 p-20'>
        {/* Logo */}
        <div className='text-white text-6xl font-bold leading-none'>
          <span className='text-green-500'>EYE-</span>OPENING
        </div>
        {/* Navigation */}
        <div className='flex flex-col justify-center gap-4 space-x-10'>
          <li><a href='/' className='font-bold text-xl text-white  uppercase'>Service</a></li>
          <li><a href='/' className='font-bold text-xl text-white uppercase'>Our Work</a></li>
          <li><a href='/' className='font-bold text-xl text-white uppercase'>About Us</a></li>
          <li><a href='/' className='font-bold text-xl text-white uppercase'>Insight</a></li>
          <li><a href='/' className='font-bold text-xl text-white  uppercase'>Contact Us</a></li>
        </div>
        <div className='w-full justify-between h-10 p-7 flex '>
      <svg width="72" height="30" viewBox="0 0 72 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <h1>&copy; Yash(2024)</h1>
      </div>
      </div>

      {/* Right Section */}
      <div className='flex flex-col justify-between w-1/2 p-20'>
        {/* Presentation */}
        <h1 className='text-white text-6xl font-semibold leading-none'>PRESENTATION</h1>
        {/* Social Links */}
        <div className='flex flex-col gap-4 justify-between h-[40vh] p-5 rounded-lg bg-zinc-900'>
          <a href='/' className='text-white text-lg font-bold hover:text-green-500 hover:scale-105'>FACEBOOK</a>

          <a href='/' className='text-white text-lg font-bold hover:text-green-500 hover:scale-105'>INSTAGRAM</a>
          <a href='/' className='text-white text-lg font-bold hover:text-green-500 hover:scale-105'>TWITTER</a>
        </div>
      </div>
