...
const Cards = () => {
  return (
    <div className='w-full h-fit justify-center items-center bg-black px-14 py-20 gap-5'>
        <div className='p-10 flex gap-5'>
        <div className='flex relative hover:border-white-1 border items-center justify-center w-1/2 rounded-xl h-[40vh] bg-[#004D43]'>
        <svg width="92" height="45" viewBox="0 0 72 30" fill="none" xmlns="http://www.w3.org/2000/svg">
           ...
           <div className='absolute border bottom-1 left-1 border-1 p-1 rounded-xl'>
            &copy;2019-2022
           </div>

        </div>
        <div className='flex gap-5 w-1/2'>
        <div className='bg-zinc-900 hover:border-white-1 border flex items-center justify-center relative w-1/2 h-[40vh] rounded-xl'>
<h1 className='text-4xl font-bold'>Clutch</h1>
        </div>
        <div className='bg-zinc-900 hover:border-white-1 border flex items-center justify-center relative w-1/2 h-[40vh] rounded-xl'>
        <img class="bg-gray-200 entered loaded"  src="https://ochi.design/wp-content/uploads/2022/04/logo003.png" height="104" width="102" data-src="https://ochi.design/wp-content/uploads/2022/04/logo003.png" alt="https://ochi.design/wp-content/uploads/2022/04/logo003.png" ></img>
        <h2 className='capitlaize'></h2>
          </div> 
